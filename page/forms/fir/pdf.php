...
$mpdf=new mPDF('UTF-8','A4-L','','',5,5,73.5,60,5,5,'P'); 
	...
	<table style='width:100%' class='yes'>
		...
		<tbody>
			<tr>
				...
				<td style='width:35%'>$batchnumber</td>
			</tr>
			<tr>
				<td style='width:15%'><b>PART NUMBER</b></td>
				<td style='width:35%'>$partnumber</td>
				<td style='width:15%'><b>TOTAL LOT QTY</b></td>
				<td style='width:35%'>$totallotqty</td>
			</tr>
			<tr>
				<td style='width:15%'><b>PART NAME</b></td>
				<td style='width:35%'>$partname</td>
				<td style='width:15%'><b>STANDARD QC</b></td>
				<td style='width:35%'>$standardqc</td>
			</tr>
			<tr>
				<td style='width:15%'><b>CHECK CODE</b></td>
				<td style='width:35%'>$checkcode</td>
...
echo "
	<table style='width:100%' class='yes'>
		<tbody>
			<tr>
				<td width='50%' rowspan='3'><b>Last Known Issue:</b><br/><br/><pre>$lastissue</pre></td>
				<td valign='middle' width='17%' height='25px'><b>Issue From Production</b></td>
				<td valign='middle' width='33%'>$issueproduction</td>
			</tr>
			<tr>
				<td valign='middle' height='25px'><b>Receipt From Production</b></td>
				<td valign='middle'>$receiptproduction</td>
			</tr>
			<tr>
				<td valign='middle' height='25px'><b>Inventory Transfer</b></td>
				<td valign='middle'>$inventorytransfer</td>
			</tr>
		</tbody>
	</table>
	<table style='width:100%' class='yes'>
		<tbody>
			<tr>
				<td width='50%' height='63px'><b>Final Decision:</b><br/><br/>
				<table class='no' width='100%'>
				<tr>
				<td width='160px'><h1>"; if($final == 'PASS'){echo '&#9745;';}else{echo '&#9744;';} echo " PASS</h1></td>
				<td width='200px'><h1>"; if($final == 'REWORK'){echo '&#9745;';}else{echo '&#9744;';} echo " REWORK</h1></td>
				<td width='170px'><h1>"; if($final == 'REJECT'){echo '&#9745;';}else{echo '&#9744;';} echo " REJECT</h1></td>
				</tr>
				</table>
				</td>
				<td width='50%'><b>Remark:</b><br/><br/><pre>$remark</pre></td>
			</tr>
		</tbody>
	</table>
	<table style='width:100%' class='yes'>
        <thead>
			<tr>
				<th colspan='1' width='30%' bgcolor='#cccccc'></th>
				<th colspan='1' width='30%' bgcolor='#cccccc'>NAME</th>
				<th colspan='1' width='20%' bgcolor='#cccccc'>STATUS</th>
				<th colspan='1' width='20%' bgcolor='#cccccc' align='center'>DATE</th>
			</tr>
        </thead>
		<tbody>
			<tr>
				<td colspan='1'>Inspected By</td>
				<td colspan='1'>$name</td>
				<td colspan='1' align='center'>Submitted</td>
				<td colspan='1' align='center'>$datecreated</td>
			</tr>
			<tr>
				<td>Checked By</td>
				<td>$approval1_name</td>
				<td align='center'>$status1_label</td>
				<td align='center'>$date1</td>
			</tr>
			<tr>
				<td>Approved By</td>
				<td>$approval2_name</td>
				<td align='center'>$status2_label</td>
				<td align='center'>$date2</td>
			</tr>
		</tbody>
    </table>
	<table style='width:100%;margin-bottom:-3px' class='no'>
		<tbody>
			<tr>
				<td align='left'>$formnumber</td>
