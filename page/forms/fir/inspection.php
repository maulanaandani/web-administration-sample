...
if($id == "prodqty1"){
	$totallotqty = $prodqty1;
}
else if($id == "prodqty2"){
	$totallotqty = $prodqty2;
}
else if($id == "prodqty3"){
	$totallotqty = $prodqty3;
}
else if($id == "prodqty4"){
	$totallotqty = $prodqty4;
}
else if($id == "prodqty5"){
	$totallotqty = $prodqty5;
}
else{
...
if($cekmasterinspection > 0){
	...
	$r_application = mysql_fetch_array(mysql_query("SELECT * FROM form_fir_master_inspection WHERE standardqc='$standardqc' $sql_stdqc AND inspectionitem='Application'"));
	...
	if(strpos($r_application['ac'], '%') !== false){$r_application_ac = ($totallotqty * $r_application['ac'])/100;}else{$r_application_ac = $r_application['ac'];}
	if(strpos($r_application['re'], '%') !== false){$r_application_re = ($totallotqty * $r_application['re'])/100;}else{$r_application_re = $r_application['re'];}
	if(strpos($r_application['n'], '%') !== false){$r_application_n = (/* $totallotqty */ $prodqty1 * $r_application['n'])/100;}else{$r_application_n = $r_application['n'];}
	if(strpos($r_application['n'], '%') !== false){$r_application_n2 = (/* $totallotqty */ $prodqty2 * $r_application['n'])/100;}else{$r_application_n2 = $r_application['n'];}
	if(strpos($r_application['n'], '%') !== false){$r_application_n3 = (/* $totallotqty */ $prodqty3 * $r_application['n'])/100;}else{$r_application_n3 = $r_application['n'];}
	if(strpos($r_application['n'], '%') !== false){$r_application_n4 = (/* $totallotqty */ $prodqty4 * $r_application['n'])/100;}else{$r_application_n4 = $r_application['n'];}
	if(strpos($r_application['n'], '%') !== false){$r_application_n5 = (/* $totallotqty */ $prodqty5 * $r_application['n'])/100;}else{$r_application_n5 = $r_application['n'];}
	...
	$r_application_n = $r_application_n != "" ? round($r_application_n) : "";
	$r_application_n2 = $r_application_n2 != "" ? round($r_application_n2) : "";
	$r_application_n3 = $r_application_n3 != "" ? round($r_application_n3) : "";
	$r_application_n4 = $r_application_n4 != "" ? round($r_application_n4) : "";
	$r_application_n5 = $r_application_n5 != "" ? round($r_application_n5) : "";
	...
	if($prodqty1 == ""){$r_application_n = "";}
	if($prodqty2 == ""){$r_application_n2 = "";}
	if($prodqty3 == ""){$r_application_n3 = "";}
	if($prodqty4 == ""){$r_application_n4 = "";}
	if($prodqty5 == ""){$r_application_n5 = "";}
	
	echo "#Identity|$r_identity_ac|$r_identity_re|$r_identity_n|$r_identity_n2|$r_identity_n3|$r_identity_n4|$r_identity_n5";
	echo "#Packaging|$r_packaging_ac|$r_packaging_re|$r_packaging_n|$r_packaging_n2|$r_packaging_n3|$r_packaging_n4|$r_packaging_n5";
	echo "#Quantity|$r_quantity_ac|$r_quantity_re|$r_quantity_n|$r_quantity_n2|$r_quantity_n3|$r_quantity_n4|$r_quantity_n5";
	echo "#Appearance|$r_appearance_ac|$r_appearance_re|$r_appearance_n|$r_appearance_n2|$r_appearance_n3|$r_appearance_n4|$r_appearance_n5";
	echo "#Application|$r_application_ac|$r_application_re|$r_application_n|$r_application_n2|$r_application_n3|$r_application_n4|$r_application_n5";
